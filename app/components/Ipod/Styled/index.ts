...
export const Shell = styled.div<{ $deviceTheme: DeviceThemeName }>`
  ...
  ${Screen.SM.MediaQuery} {
    ...
    /* Add safe area padding for the Dynamic Island */
...
export const ScreenContainer = styled.div`
  ...
  ${Screen.SM.MediaQuery} {
    /* Shift display down significantly to clear Dynamic Island + extra breathing room */
    margin: 30px ${Unit.MD} 0;
  }
`;
...
export const ClickWheelContainer = styled.div`
  ...
  ${Screen.SM.MediaQuery} {
    /* Shift the joystick down by anchoring it to the bottom instead of centering */
    margin-top: auto;
    margin-bottom: 70px;
  }
`;
